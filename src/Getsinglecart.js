...
function Getsinglecart() {
  ...
  let [ele,setele]=useState({});
    ...
    const cartdata1 = (i,price) => {
        console.log(i);
        dispatch(cartsingle({ data: ele, id: i,price:price }))
    }
                ...
                <Container>
                    <Row className='justify-content-between align-items-center py-3 '>
                        ...
                        <Col sm='auto' className='text-center '>
                            ...
                            <Link to='/Addcart'><button className='mt-0'>GO TO CART</button></Link>
